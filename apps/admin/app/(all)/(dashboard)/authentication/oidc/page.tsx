 ...
 *
 * woven: OIDC SSO admin page (Open-EE). Mirrors the CE Gitea page; owns the IS_OIDC_ENABLED
 * master toggle and renders the OIDC config form.
 */
    ...
    <PageWrapper
      customHeader={
        <AuthenticationMethodCard
          name="OIDC SSO"
          description="Allow members to log in or sign up to Plane with your OpenID Connect (OIDC) provider."
