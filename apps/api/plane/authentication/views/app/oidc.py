...
#
# woven: Generic OIDC SSO views (Open-EE, feature: OIDC/SAML SSO). App-portal initiate +
# callback endpoints, mirroring the CE Google/Gitea OAuth views (state-CSRF check +
# Instance.is_setup_done gate). Not derived from Plane's Commercial/EE OIDC code.
